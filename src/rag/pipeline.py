...
class RAGPipeline:
    ...
    def answer_query(self, query_text: str, n_results: int = 3, llm_backend: str = None, model: str = None) -> dict:
        """
        ...
        # 2. Generation
        answer = self.generator.generate_answer(context, query_text, llm_backend=llm_backend, model=model)
